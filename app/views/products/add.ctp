...
<?php echo $form->create('Product');?>
	<fieldset style="background:#f7f7f7;width:500px;">
 		<legend><?php __('Adauga produs nou');?></legend><br/><br/>
       ...
       <tr><td>Tara de origine</td><td><? echo $form->input('tara',array('label'=>'','style'=>'width:100px;'));?></td></tr>
        ...
        <tr style="background:#eeeeee;"><td>Caracteristici senzoriale<br />la 20 grade Celsius</td>
         ...
         <tr style="background:#eeeeee;"><td>Ambalare si etichetare</td> <td><table>
           ...
           <tr><td>Conditii de transport</td><td><? echo $form->input('condTransp',array('label'=>'','style'=>'width:200px;;'));?></td></tr>
        ...
        <tr><td>Linia de productie</td><td><?php echo $form->select('line_id', array('0' => 'nespecificata' ,'1' => 'linia_1','2' =>'linia_2' ,
		'3'=>'linia_3','4' => 'linia_4'),'nespecificata',array('onchange'=>'jsfunction(this);','label'=>''), false);?></td></tr>
...
<tr><td colspan="2"><?php echo $form->end('Adauga Produs');?></td></tr></table>
</div>
