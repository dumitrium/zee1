...
<tr><td><b>Valoare nutritionala</b></td><td >Umiditate: '.$product['Product']['umiditate'].' % max<br/>Proteine: '.round($proteine,1).' %<br>Glucide: '.round($carbo,1).' %<br>Lipide: '.round($gras,1).' %<br/>Valoare energetica: '.round($kcal,1).' kcal/100g; '.round($kj,1).' kj/100g</td></tr>
...
<br/><br/><br/><h1>&nbsp;</h1><br/><br/><h1>&nbsp;</h1><br/><br/><h1>&nbsp;</h1><br/><br/>';
