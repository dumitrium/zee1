<?php echo $html->link(__('Sterge caracteristicile ingredientului', true), array('action'=>'delete', $form->value('ProductNutritional.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('ProductNutritional.id'))); ?>&nbsp;|&nbsp;
<?php echo $html->link(__('Listeaza caracteristicile tuturor ingredientelor', true), array('action'=>'index'));?>

<div class="ngredientCaracteristics" align="left">
<?php echo $form->create('ProductNutritional');?>
<fieldset style="none">
 		<legend>Editeaza valorile nutritive ale produsului</legend>
	<?php
...
<table align="left" width="297">
	...
	<tr><td> - monosaturate</td><td><?echo $form->input('grasimiMonoNesaturate',array('label'=>'','class'=>'formscurt'));?></td><td>g/100g</td></tr>
	<tr><td> - polisaturate</td><td><?echo $form->input('grasimiPoliNesaturate',array('label'=>'','class'=>'formscurt'));?></td><td>g/100g</td></tr>
...
<?php echo $form->end('Trimite valori nutritive produs');?>
</div>
