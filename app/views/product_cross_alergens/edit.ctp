...
&nbsp;|&nbsp; <?php 
echo $form->create('ProductCrossAlergen');?>
	<fieldset style="background:#f6f6f6;width:600px;">
 		<legend>Editeaza alergenii cross contaminare ai produsului></legend><br/>
	<?php
...
<!--
	<ul>
		<li><?php echo $html->link(__('Sterge alergenii cross contaminare ai produsului', true), array('action'=>'delete', $form->value('IngredientAlergen.id')), null, sprintf(__('Esti sigur ca vrei sa stergi # %s?', true), $form->value('ProductCrossAlergen.id'))); ?></li>
