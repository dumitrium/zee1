...
<?php echo $form->create('IngredientGeneticModification');?>
	<fieldset style="width:930px;vertical-align:middle;background:#f6f6f6;">
 		<legend>&nbsp;&nbsp;<strong style="color:#666666;"><?php
	echo $ingredients[$ingred];?></strong>&nbsp;- adauga modificari genetice</legend><br/><br/>
	<?php
...
<tr><td style="color:#000000;"><b>&nbsp;&nbsp;Soia&nbsp; &nbsp; </b>	</td><td><?php echo $form->select('soiaPrezent', array('prezent' => 'prezent','absent'=>'absent'),'absent',array('onchange'=>'jsfunction(this);','label'=>''), false);?></td>
	<td><?echo $form->textarea('soiaIngredient',array('value'=>'test', 'label'=>'','class'=>'formscurt', 'style'=>'width:200px;height:30px;font-size:11px;margin:5px;','rows'=>'5'));?></td>
...
<tr bgcolor="#dddddd"style="color:#000000;" ><td><b>&nbsp;&nbsp;Porumb</b>	</td><td><?php echo $form->select('porumbPrezent', array('prezent' => 'prezent','absent'=>'absent'),'absent',array('onchange'=>'jsfunction(this);','label'=>''), false);?></td>
...
<tr><td style="color:#000000;"><b>&nbsp;&nbsp;Rapita</b>	</td><td><?php echo $form->select('rapitaPrezent', array('prezent' => 'prezent','absent'=>'absent'),'absent',array('onchange'=>'jsfunction(this);','label'=>''), false);?></td>
...
<tr bgcolor="#dddddd"style="color:#000000;"><td><b>&nbsp;&nbsp;Bumbac</b>	</td><td><?php echo $form->select('bumbacPrezent', array('prezent' => 'prezent','absent'=>'absent'),'absent',array('onchange'=>'jsfunction(this);','label'=>''), false);?></td>
...
<tr ><td style="color:#000000;" ><strong>&nbsp;&nbsp;Sfecla <br />&nbsp;&nbsp;de &nbsp;&nbsp;zahar</strong>	</td><td><?php echo $form->select('sfeclaPrezent', array('prezent' => 'prezent','absent'=>'absent'),'absent',array('onchange'=>'jsfunction(this);','label'=>''), false);?></td>
...
<tr bgcolor="#dddddd" style="color:#000000;"><td><b>&nbsp;&nbsp;Cartofi</b>	</td><td><?php echo $form->select('cartofiPrezent', array('prezent' => 'prezent','absent'=>'absent'),'absent',array('onchange'=>'jsfunction(this);','label'=>''), false);?></td>
...
<br/><br/>
<!--
	<?php echo $html->link(__('List IngredientGeneticModifications', true), array('action'=>'index'));?></li>
	<?php echo $html->link(__('List Ingredients', true), array('controller'=> 'ingredients', 'action'=>'index')); ?> </li>
	<?php echo $html->link(__('New Ingredient', true), array('controller'=> 'ingredients', 'action'=>'add')); ?> </li>
</ul>-->
</div>
