...
<tr><td><b>Metale grele</b></td><td>As  &lt; 0.30 mg/kg<br />Cd &lt; 0.10 mg/kg<br />Pb &lt; 0.50 mg/kg<br />Zn &lt; 50 mg/kg<br />Cu &lt; 20 mg/kg<br />Hg &lt; 0.02 mg/kg</td></tr>						 
...
<tr><td><b>Conditii de transport</b></td><td > Produsul se transporta in mijloace de transport acoperite, curate, fara mirosuri straine, igienizate si dezinfectate, ferite de orice posibilitate de poluare, degradare sau contaminare.</td></tr>
...
<table style="border:1px solid #000;" width="95%" border="1" >
<tr><td width="30">Nr </td><td width="300"> Nume</td><td width="15%">Agenti alergeni<br/>ingredienti</td><td width="15%">Cross contamination</td></tr>
<tr><td >1.</td><td>Cereale care contin gluten( de exemplu grau, secara, orz, ovaz, grau spelt, grau mare sau suse hibrid ale acestora) si produse derivate</td><td>'.$gluten.'</td><td>'.$glutenZ.'</td></tr>
...
<tr><td >8.</td><td>8.	Fructe nucifere, precum migdale (Amygdalus communis L.), alune de padure (Corylus avellana), nuci (Juglas regia), anacard (Anacardium occidentale), nuci pelan [Carya illinoiesis (Wangenh.) K. Koch], nuci de Brazilia (Bertholletia excelsa), fistic (Pistacia vera), nuci de Macadamia si nuci de Queensland (Macadamia ternifolia) si produse derivate</td><td>'.$nuci.'</td><td>'.$nuciZ.'</td></tr>
...
<br/>
<table><tr><td style="font-size:70%">(*) In general, sub-ingredientele nu apar in declaratia privind ingredientele.Majoritatea sunt agenti 
