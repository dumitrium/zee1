 ...
 */
	function __setDefaults() {
		...
		$defaults = array(
			...
			'loginError' => __('Autentificare esuata. Userul sau parola au fost introduse gresit.', true),
			'authError' => __('Nu esti autorizat sa accesezi aceasta pagina. E necesar sa te loghezi..', true)
		);
