...
<body>
	<div id="container" align="center">
		<div id="header">
		<?php echo $html->image('zee1.jpg', array('alt'=> __("zeelandia romania", true), 'border'=>"0", 'width'=>'100%'));?>
			</div>
...
<li><a href="/app/webroot/ingredients/logs" class="<?if(isset($classPL)) echo 'current'; else echo'';?>"><span>Istoric</span></a></li>
