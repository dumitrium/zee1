...
<h4>Cod produs: '.htmlspecialchars($product['Product']['cod']).'</h4><h4>Data: '.htmlspecialchars($product['Product']['created']).'</h4><h4> </h4><table cellspacing="0" cellpadding="0" border="1" style="margin-bottom:0px">
<tr bgcolor="#dddddd">
...
$tableEnergie=$tableEnergie.'<tr bgcolor="#dddddd">
