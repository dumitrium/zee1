<!--<?php echo $html->link(__('Listeaza caracteristicile tuturor ingredientilor', true), array('action'=>'index'));?>-->
<div style="width:480px;">
<?php echo $form->create('IngredientCaracteristic');?>
	<fieldset style="background:#f8f8f8;font-size:14px;">
 		<legend>Adauga caracteristici ingredient</legend>
	<?php
...
<tr><td colspan="3"  ><b>STANDARDE FIZICE/CHIMICE</b></td></tr>
 ...
 <tr><td> Ph</td><td colspan="2">         <? echo $form->input('ph',array('label'=>'','style'=>'width:200px;'));?></td></tr>
	...
	<tr><td> - mono-nesaturate</td><td><?echo $form->input('grasimiMonoNesaturate',array('label'=>'','class'=>'formscurt'));?></td><td>g/100g</td></tr>
	<tr><td> - poli-nesaturate</td><td><?echo $form->input('grasimiPoliNesaturate',array('label'=>'','class'=>'formscurt'));?></td><td>g/100g</td></tr>
...
<tr><td>Vitamina B1(Tiamina)</td><td><? echo $form->input('vitaminaB1',array('label'=>'','class'=>'formscurt'));?></td><td>mg/100g</td></tr>
...
<tr><td> Pb < 0,50 mg/kg</td><td><?echo $form->input('pb',array('label'=>'','class'=>'formscurt','default'=>'0.50'));?></td><td>mg/kg</td></tr>
<tr><td> Cd < 0,10 mg/kg</td><td><?echo $form->input('cd',array('label'=>'','class'=>'formscurt','default'=>'0.10'));?></td><td>mg/kg</td></tr>
<tr><td> Hg < 0,02 mg/kg</td><td><?echo $form->input('hg',array('label'=>'','class'=>'formscurt','default'=>'0.02'));?></td><td>mg/kg</td></tr>
<tr><td> As < 0,30 mg/kg</td><td><?echo $form->input('as',array('label'=>'','class'=>'formscurt','default'=>'0.30'));?></td><td>mg/kg</td></tr>
<tr><td> Zn < 50,00 mg/kg</td><td><?echo $form->input('zn',array('label'=>'','class'=>'formscurt','default'=>'50.00'));?></td><td>mg/kg</td></tr>
<tr><td> Cu < 20,00 mg/kg</td><td><?echo $form->input('cu',array('label'=>'','class'=>'formscurt','default'=>'20.00'));?></td><td>mg/kg</td></tr>
