...
<?php echo $form->create('ProductReteta');?>
	<fieldset>
 		<legend>Adauga reteta produs</legend>
...
<? for($i=0;$i<20;$i++){?>
	<tr><td><? echo $i.'.';?></td>
		<td>Ingredient:
		<td><?echo $form->select('ingredient_id'.$i, array('ingrediente'=>$ingredients), array(null=>'nulll'), array('style'=>'width:150px;background-color:#ffc;border: 1px solid #999;vertical-align:middle;','label'=>''));?>
...
<?php echo $form->end('Adauga reteta');?>
</div>
<div class="actions">
	<ul>
